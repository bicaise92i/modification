		...
		<div class="sidebar-description">
			<form id="addWidgetAreaForm" action="" method="post">
				<div class="widget-content">
					<input id="gf-add-widget-input" name="gf-add-widget-input" type="text" class="regular-text" title="<?php echo esc_attr(esc_html__('Name','beyot-framework')); ?>" placeholder="<?php echo esc_attr(esc_html__('Name','beyot-framework')); ?>" />
				</div>
				<div class="widget-control-actions">
					<input class="addWidgetArea-button button-primary" type="submit" value="<?php echo esc_attr(esc_html__('Create Widget Area', 'beyot-framework')); ?>" />
				</div>
			</form>
		</div>
	</div>
