...
{
    wp_die( esc_html__('You do not have sufficient permissions to access this page.', 'beyot-framework') );
}
...
<form name="frmChangePostTypeSlug" method="post" action="">
    <div class="page-post-type-setting">
        <h3><?php esc_html_e('Change Slug','beyot-framework') ?></h3>
        <ul>
            <li class="title"><?php esc_html_e('Current slug post type :','beyot-framework') ?></li>
            <li class="value"><?php echo esc_attr($post_type_slug) ?> &nbsp;</li>
            <li class="title"><?php esc_html_e('New slug post type: ','beyot-framework') ?></li>
            <li class="value"><input type="text" name="<?php echo esc_attr($post_type.'-slug') ?>"/></li>

            <li class="title"><?php esc_html_e('Current name post type :','beyot-framework') ?> </li>
            <li class="value"><?php echo esc_attr($post_type_name) ?> &nbsp;</li>
            <li class="title"><?php esc_html_e('New name post type : ','beyot-framework') ?></li>
            <li class="value"><input type="text" name="<?php echo esc_attr($post_type.'-name') ?>"/></li>

            <?php if($taxonomy_slug!=''){ ?>
                <li class="title"><?php esc_html_e('Current slug category : ','beyot-framework') ?></li>
                <li class="value"><?php echo esc_attr($taxonomy_slug) ?> &nbsp;</li>
                <li class="title"><?php esc_html_e('New slug category: ','beyot-framework') ?></li>
                <li class="value"><input type="text" name="<?php echo esc_attr('category-'.$post_type.'-slug') ?>"/></li>

                <li class="title"><?php esc_html_e('Current name category : ','beyot-framework') ?></li>
                <li class="value"><?php echo esc_attr($taxonomy_name) ?> &nbsp;</li>
                <li class="title"><?php esc_html_e('New name category : ','beyot-framework') ?></li>
