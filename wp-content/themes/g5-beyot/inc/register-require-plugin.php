	...
	function g5plus_register_required_plugins() {
		...
		$plugins = array(
			array(
				...
				'source'             => get_template_directory() .  '/inc/plugins/beyot-framework-v3.6.zip', // The plugin source
			...
			array(
				...
				'source'             => get_template_directory() .  '/inc/plugins/js_composer-v5.4.5.zip', // The plugin source
				'required'           => true, // If false, the plugin is only 'recommended' instead of required
